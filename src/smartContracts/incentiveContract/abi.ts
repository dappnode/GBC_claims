const abi = [
  { type: "event", name: "CancelIncentive", inputs: [], anonymous: false },
  {
    ...
    inputs: [{ type: "address", name: "beneficary", internalType: "address", indexed: true }],
    anonymous: false,
  },
  ...
  { type: "event", name: "RenewIncentive", inputs: [], anonymous: false },
  {
    ...
    inputs: [{ type: "uint256", name: "newIncentiveDuration", internalType: "uint256", indexed: false }],
    anonymous: false,
  },
  {
    type: "event",
    name: "SetValidatorNum",
    inputs: [{ type: "uint256", name: "newValidatorNum", internalType: "uint256", indexed: false }],
    anonymous: false,
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "claimTokens",
    inputs: [
      { type: "address", name: "_token", internalType: "contract IERC20Upgradeable" },
  ...
  },
  {
    ...
    outputs: [],
    name: "setIncentiveDuration",
    inputs: [{ type: "uint256", name: "newIncentiveDuration", internalType: "uint256" }],
  },
  {
    type: "function",
    stateMutability: "nonpayable",
    outputs: [],
    name: "setValidatorNum",
    inputs: [{ type: "uint256", name: "newValidatorNum", internalType: "uint256" }],
  },
  {
    type: "function",
    stateMutability: "nonpayable",
